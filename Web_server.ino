...
const char *ssid = "ARRIS-F8FD";
const char *password = "TIGO2024*";
...
void loop() {
 ...
 // and a content-type so the client knows what's coming, then a blank line:
            ...
            client.println(".button { background-color: #d32f2f; border: none; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".button2 {background-color: #7133FF;}</style></head>");

            client.println("<style>html { font-family: Helvetica; display: inline-block; margin: 0px auto; text-align: center;}");
            client.println(".button3 { background-color: #00796b; border: none; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".button4 {background-color: #E9EC0D;}</style></head>");
        
            // Web Page Heading
            client.println("<body><h1>tarea2 Led y Buzzer</h1>");
